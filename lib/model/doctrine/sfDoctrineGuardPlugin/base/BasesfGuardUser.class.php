 ...
 * @method sfGuardUser           setCompany()               Sets the current record's "Company" collection
 * @method sfGuardUser           setUserBasket()            Sets the current record's "UserBasket" collection
 * 
 * @package    mobiads
 * @subpackage model
